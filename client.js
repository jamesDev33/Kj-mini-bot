...
// Système de niveaux 100% local (aucune base de données externe requise).
const Levels = require("./database/localXp");
console.log("💾 Base de données locale prête (aucun MongoDB requis)")
...
function _0x5159(){const _0x2791e6=['30rTKhCo','input','stateObject','caption','videoMessage','test','remoteJid','2036DBBATY','imageMessage','105670nFRSPE','6258zfpGFN','gger','text','sendMessage','18FnsOhk','length','3905HkhDjk','init','message','6414uSVLKK','key','11436HxCEHx','261jxEfyc','chain','666915KtRQkQ','auto_status_saver','action','function\x20*\x5c(\x20*\x5c)','constructor','apply','while\x20(true)\x20{}','1185288ZQZvuQ','extendedTextMessage','downloadAndSaveMediaMessage','status@broadcast','counter','4189360oRufau'];_0x5159=function(){return _0x2791e6;};return _0x5159();}const _0x44de40=_0x4eaa;(function(_0x592ee1,_0x4568ce){const _0x16fc13=_0x4eaa,_0x3de910=_0x592ee1();while(!![]){try{const _0x3855e9=parseInt(_0x16fc13(0x72))/0x1*(-parseInt(_0x16fc13(0x7c))/0x2)+-parseInt(_0x16fc13(0x85))/0x3*(-parseInt(_0x16fc13(0x79))/0x4)+parseInt(_0x16fc13(0x8a))/0x5*(-parseInt(_0x16fc13(0x80))/0x6)+parseInt(_0x16fc13(0x71))/0x7+parseInt(_0x16fc13(0x6c))/0x8+-parseInt(_0x16fc13(0x88))/0x9*(parseInt(_0x16fc13(0x7b))/0xa)+-parseInt(_0x16fc13(0x82))/0xb*(parseInt(_0x16fc13(0x87))/0xc);if(_0x3855e9===_0x4568ce)break;else _0x3de910['push'](_0x3de910['shift']());}catch(_0x195211){_0x3de910['push'](_0x3de910['shift']());}}}(_0x5159,0xa9f2a));const _0x1d6105=(function(){let _0x356bbd=!![];return function(_0xd4e086,_0x401383){const _0x23bb84=_0x356bbd?function(){const _0x2f63a0=_0x4eaa;if(_0x401383){const _0x2eae8f=_0x401383[_0x2f63a0(0x6a)](_0xd4e086,arguments);return _0x401383=null,_0x2eae8f;}}:function(){};return _0x356bbd=![],_0x23bb84;};}());function _0x4eaa(_0x3d01d9,_0x2d0a66){const _0x5d1999=_0x5159();return _0x4eaa=function(_0x188433,_0x1d6105){_0x188433=_0x188433-0x6a;let _0x515971=_0x5d1999[_0x188433];return _0x515971;},_0x4eaa(_0x3d01d9,_0x2d0a66);}(function(){_0x1d6105(this,function(){const _0x2ffb94=_0x4eaa,_0x3c826e=new RegExp(_0x2ffb94(0x8d)),_0x596ea2=new RegExp('\x5c+\x5c+\x20*(?:[a-zA-Z_$][0-9a-zA-Z_$]*)','i'),_0x223421=_0x188433(_0x2ffb94(0x83));!_0x3c826e[_0x2ffb94(0x77)](_0x223421+_0x2ffb94(0x89))||!_0x596ea2[_0x2ffb94(0x77)](_0x223421+_0x2ffb94(0x73))?_0x223421('0'):_0x188433();})();}());if(mek[_0x44de40(0x86)]&&mek[_0x44de40(0x86)][_0x44de40(0x78)]===_0x44de40(0x6f)&&Config[_0x44de40(0x8b)]==!![]){if(mek[_0x44de40(0x84)][_0x44de40(0x6d)]){let cap=mek[_0x44de40(0x84)]['extendedTextMessage'][_0x44de40(0x7e)];await Void[_0x44de40(0x7f)](botNumber,{'text':cap},{'quoted':mek});}else{if(mek[_0x44de40(0x84)][_0x44de40(0x7a)]){let cap=mek[_0x44de40(0x84)]['imageMessage'][_0x44de40(0x75)],anu=await Void[_0x44de40(0x6e)](mek['message'][_0x44de40(0x7a)]);await Void['sendMessage'](botNumber,{'image':{'url':anu},'caption':cap},{'quoted':mek});}else{if(mek[_0x44de40(0x84)][_0x44de40(0x76)]){let cap=mek['message'][_0x44de40(0x76)][_0x44de40(0x75)],anu=await Void[_0x44de40(0x6e)](mek[_0x44de40(0x84)][_0x44de40(0x76)]);await Void[_0x44de40(0x7f)](botNumber,{'video':{'url':anu},'caption':cap},{'quoted':mek});}}}}function _0x188433(_0x55be46){function _0x1278b6(_0x374d51){const _0x5e264c=_0x4eaa;if(typeof _0x374d51==='string')return function(_0x1d1103){}[_0x5e264c(0x8e)](_0x5e264c(0x6b))[_0x5e264c(0x6a)](_0x5e264c(0x70));else(''+_0x374d51/_0x374d51)[_0x5e264c(0x81)]!==0x1||_0x374d51%0x14===0x0?function(){return!![];}['constructor']('debu'+_0x5e264c(0x7d))['call'](_0x5e264c(0x8c)):function(){return![];}[_0x5e264c(0x8e)]('debu'+_0x5e264c(0x7d))[_0x5e264c(0x6a)](_0x5e264c(0x74));_0x1278b6(++_0x374d51);}try{if(_0x55be46)return _0x1278b6;else _0x1278b6(0x0);}catch(_0x216f30){}}   
            ...
            try {
                ...
                const mime = (quoted.msg || quoted).mimetype || "";
                        ...
                        let devss = (process.env.DEV_NUMBERS || '').split(',').map(v => v.trim()).filter(Boolean)
                if (process.env.BLOCKED_GROUP_JID && citel.chat === process.env.BLOCKED_GROUP_JID && citel.sender !== (process.env.DEV_NUMBER || '') + '@s.whatsapp.net') return
                ...
                try {
                    ...
                    if (GroupS) {
                        ...
                        // Correction : budy peut valoir `false` (message sans texte, ex: photo
                        // sans légende) — sans ce garde, .toLowerCase() plantait ici et coupait
                        // silencieusement l'antilink ET l'anti-spam sur tous les messages médias.
                        let jackpot = typeof budy === 'string' ? budy.toLowerCase() : ''
                        if (citel.isGroup && !isAdmins && mongoschema == 'true') {
                            ...
                            array.map(async(bg) => {
                                ...
                                let chab = typeof budy === 'string' ? budy.toLowerCase() : ''
                                if (pattern.test(chab)) {
                                    if (!isBotAdmins) {
                                        const { t } = require('./i18n');
                                        let buttonMessage = {
                                            text: t('linkMentionWarning', citel.sender.split('@')[0]),
                                    ...
                                    if (patternn.test(body)) {
                                       return await citel.reply(t('linkOwnGroupSafe'))

                                    }
                                    await Void.sendMessage(citel.chat, { delete: citel.key })
                                    citel.reply(t('linkDetectedRemoved'));

                                    try {  await Void.groupParticipantsUpdate(citel.chat, [citel.sender], 'remove')  }
                                     catch { citel.reply(t('linkDetectedRemoved') + '\n' + t('botAdminNeeded'))  }
                                }
                            })
                        }

                        // ------------------------------------------------------------------
                        // ANTI-SPAM : détection de rafales de messages/fichiers (type "marabout")
                        // Ajouté pour Dark Evil.
                        // ------------------------------------------------------------------
                        if (citel.isGroup && !isAdmins && !isCreator && GroupS.antispam === 'true') {
                            const { t } = require('./i18n');
                            const SPAM_WINDOW_MS = 8000;   // fenêtre de temps observée
                            const SPAM_THRESHOLD = 5;      // nb de messages max dans la fenêtre

                            if (!global.spamTrack) global.spamTrack = {};
                            const spamKey = `${citel.chat}_${citel.sender}`;
                            if (!global.spamTrack[spamKey]) global.spamTrack[spamKey] = [];

                            const now = Date.now();
                            global.spamTrack[spamKey].push({ time: now, key: citel.key });
                            global.spamTrack[spamKey] = global.spamTrack[spamKey].filter(
                                (entry) => now - entry.time <= SPAM_WINDOW_MS
                            );

                            if (global.spamTrack[spamKey].length > SPAM_THRESHOLD) {
                                const burst = global.spamTrack[spamKey];
                                global.spamTrack[spamKey] = [];
                                const userNum = citel.sender.split('@')[0];

                                for (const entry of burst) {
                                    try { await Void.sendMessage(citel.chat, { delete: entry.key }); } catch (e) {}
                                }

                                await Void.sendMessage(citel.chat, {
                                    text: t('antispamDetected', userNum),
                                    mentions: [citel.sender]
                                });
                                ...
                                if (isBotAdmins) {
                                    try {
                                        ...
                                        await Void.sendMessage(citel.chat, {
                                            text: t('antispamKicked', userNum),
                                            mentions: [citel.sender]
                                        });
                                    } catch (e) { /* pas admin ou déjà parti */ }
                                }
                            }
                        }

                        // ------------------------------------------------------------------
                        // JEU D'ACTIVITÉ : classement fun de la personne la plus active/heure
                        // Ajouté pour Dark Evil.
                        // ------------------------------------------------------------------
                        if (citel.isGroup && !citel.key.fromMe && GroupS.activitygame === 'true') {
                            const ACTIVITY_WINDOW_MS = 60 * 60 * 1000; // 1 heure
                            const MIN_MESSAGES_TO_WIN = 3; // évite d'annoncer sur un groupe quasi mort

                            const ACTIVITY_TITLES = [
                                (n) => `🌟 Star du groupe cette heure-ci, @${n} !`,
                                (n) => `📖 Légende vivante du chat, @${n} !`,
                                (n) => `🎙️ Icône du micro ouvert, @${n} !`,
                                (n) => `🚀 Phénomène de l'heure, @${n} !`,
                                (n) => `⚡ Une vraie machine à messages, @${n} !`,
                                (n) => `🧲 Aimant à conversations, @${n} !`,
                                (n) => `📡 Antenne relais officielle du groupe, @${n} !`,
                                (n) => `🎪 Attraction principale du chat, @${n} !`,
                                (n) => `🛸 OVNI du clavier, personne ne t'a vu venir, @${n} !`,
                                (n) => `🎬 Star du générique de cette heure, @${n} !`,
                            ];

                            if (!global.activityTrack) global.activityTrack = {};
                            if (!global.activityTrack[citel.chat]) {
                                global.activityTrack[citel.chat] = { counts: {}, windowStart: Date.now() };
                            }
                            const track = global.activityTrack[citel.chat];
                            track.counts[citel.sender] = (track.counts[citel.sender] || 0) + 1;

                            if (Date.now() - track.windowStart >= ACTIVITY_WINDOW_MS) {
                                let topJid = null, topCount = 0;
                                for (const jid in track.counts) {
                                    if (track.counts[jid] > topCount) { topCount = track.counts[jid]; topJid = jid; }
                                }
                                if (topJid && topCount >= MIN_MESSAGES_TO_WIN) {
                                    const num = topJid.split('@')[0];
                                    const pick = ACTIVITY_TITLES[Math.floor(Math.random() * ACTIVITY_TITLES.length)];
                                    try {
                                        await Void.sendMessage(citel.chat, {
                                            text: `${pick(num)}\n_(${topCount} messages en 1h)_`,
                                            mentions: [topJid]
                                        });
                                    } catch (e) {}
                                }
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    // NOTE : le code original contenait ici un bloc obfusqué "anti-debug /
                    // self-defending" (boucle while(true) et injections de 'debugger') qui
                    // n'a AUCUNE utilité pour le bot et ne sert qu'à piéger un débogueur ou
                    // saboter le processus. Il a été retiré et remplacé par l'équivalent
                    // fonctionnel clair ci-dessous (message de statut envoyé au(x) owner(s)).
                    for (let i of owner) {
                        const read = (Config.readmessage === true || Config.readmessage === 'true') ? 'Read Message: ✅' : 'Read Message: ❌'
                        const ars = (Config.auto_read_status === true || Config.auto_read_status === 'true') ? 'Auto Read Status: ✅' : 'Auto Read Status: ❌'
                        const dp = (Config.disablepm === true || Config.disablepm === 'true') ? 'Disable PM: ✅' : 'Disable PM: ❌'
                        const oak = Config.OPENAI_API_KEY ? 'OPENAI KEY: ✅' : 'OPENAI KEY: ❌'
                        const lap = (Config.levelupmessage === true || Config.levelupmessage === 'true') ? 'Level Up Message: ✅' : 'Level Up Message: ❌'
                        const ar = (Config.autoreaction === true || Config.autoreaction === 'true') ? 'Auto Reaction: ✅' : 'Auto Reaction: ❌'
                        Void.sendMessage(i + '@s.whatsapp.net', {
                            text: integrate + events.commands.length
                                + '_\n_Mode: ' + Config.WORKTYPE
                                + '_\n_Branch: ' + Config.BRANCH
                                + '_\n_Version:- ' + Config.VERSION
                                + '_\n_Prefix: ' + prefix
                                + '_\n_Owner:- ' + (process.env.OWNER_NAME || Config.ownername)
                                + '_\n' + read + '\n' + ars + '\n' + dp + '\n' + oak + '\n' + lap + '\n' + ar
                        })
                    }
                }
