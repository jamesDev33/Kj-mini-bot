...
async function remove(h) {
	...
	jj = `Plugin ${h} supprimé de la base locale.`
	} catch {
...
// Les fonctions "adultvid" et "hentai" (contenu pour adultes) ont été retirées
// intentionnellement : elles n'étaient de toute façon reliées à aucune
// commande accessible, et ce type de contenu n'est pas inclus dans ce bot.
